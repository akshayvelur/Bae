        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Boots",
                style: appFonts.flextext(blackclr, size: 28, Fweight: 500),
              ),
              Container(
                height: mediaqueryHight(.08, context),
                width: mediaqueryWidth(.15, context),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10), color: blackclr,image: DecorationImage(image: AssetImage("assets/icons8-flash-48.png"))),
              )
            ],
          ),
        ));
