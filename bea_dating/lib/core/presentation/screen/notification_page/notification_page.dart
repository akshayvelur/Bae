                  ...
                  return requesters.isNotEmpty
                      ? ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            var user = mynotify.firstWhere(
                              (user) => user["uid"] == requesters[index],
                            );
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: ListTile(
                                        ...
                                        trailing: message[index] == "request"
                                            ? Padding(
                      ...
                      Center(
                          child: LottieBuilder.asset(
                              "assets/Animation - 1728964414856.json"),
                        );
                },
              ));
        },
