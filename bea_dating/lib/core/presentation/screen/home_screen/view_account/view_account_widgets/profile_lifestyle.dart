...
class ViewLifeStyleWidget extends StatelessWidget {
  const ViewLifeStyleWidget({
    super.key,
    ...
    return  Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          if(myuser.profile['drink']!=null)  ViewUserCoreCollection(
            ...
            if(myuser.profile['smoke']!=null)   ViewUserCoreCollection(
          ...
          if(myuser.profile['gym']!=null)  ViewUserCoreCollection(
