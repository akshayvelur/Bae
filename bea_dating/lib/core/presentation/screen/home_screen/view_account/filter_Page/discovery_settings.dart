                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: InkWell(onTap: (){
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(color:index==currentIndex?clrGreen:whiteclr,boxShadow: [BoxShadow(blurRadius: 5,offset: Offset(0,0))],
                                          borderRadius: BorderRadius.circular(10)),
                                      child: Center(child: Padding(
                                        padding: const EdgeInsets.only(left: 21.5,right: 21.5
                                        ),
                                        child: Text(genderpre[index],style: appFonts.flextext(blackclr
                                        ,size: 14,Fweight: 400),),
                                      )),
                                    ),
                                  ),
